...
- [ ] **P1.5-B 最近积累最小 UI**
  - [ ] 学习页顶部增加“知识积累”区，展示术语、解释、方向、积累时间和来源
  - [ ] 点击来源可回到原截图；不复制术语本的搜索、筛选和治理功能
  - [ ] 现有复习与学习建议下移并保持原逻辑，不在本阶段扩展
- [ ] **P1.5-C 证据型相关知识**
  - [ ] 基于现有 `term_captures` 动态计算同来源共现，不新增 `term_pairs`
  - [ ] 展示相关术语、共同来源、共同方向和可理解的关联理由
- [ ] **P1.5-D 带理由的延伸推荐**
